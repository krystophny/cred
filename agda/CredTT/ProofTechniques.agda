...
-- STATUS (Issue #119): Modules 21-27 wrap record definitions from
-- StabilityTheorems.NativeTechniques; module 28 (LimitTheorems) contains
-- conceptual notes only. See StabilityTheorems.agda for definitions.
-- ============================================================
