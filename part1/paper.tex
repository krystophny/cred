...
but that the RM3 and G\"odel implications fail.
...
G\"odel fail.  Every copula yields a Bayes-consistent arrow
...
\L ukasiewicz, G\"odel, or classical algebras, making the Kleene lattice the
...
implication passes; RM3 and G\"odel fail.  Every copula yields a
Bayes-consistent arrow (machine-checked on three values; pen-and-paper
on $[0,1]$).
...
dependence)---and every copula yields a Bayes-consistent arrow, explaining
why the non-copula RM3 and G\"odel arrows fail.
