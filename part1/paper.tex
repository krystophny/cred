...
\item \texttt{rm3\_not\_bayes\_consistent}: RM3 implication fails Bayes consistency (using \texttt{ThreeVal.conj}, i.e.\ $\min$; on $\{0,\tfrac{1}{2},1\}$ the $\min$ and multiplication checks coincide)
\item \texttt{godel\_bayes\_consistent}: G\"odel/product residuated is Bayes-consistent on $\{0,\tfrac{1}{2},1\}$ (same remark)
