...
(* Find credtt-impl directory by looking for dune-project *)
...
let () =
  ...
  test "credences.ptt type checks" (check_succeeds "test/examples/credences.ptt");
  test "weakening.ptt type checks" (check_succeeds "test/examples/weakening.ptt");
  test "credence_mul.ptt type checks" (check_succeeds "test/examples/credence_mul.ptt");
  ...
  test "sqrt2.ptt concludes credence 1" (check_contains "test/proofs/sqrt2.ptt" "1");
  ...
  test "double_negation.ptt forces c=0" (check_contains "test/proofs/double_negation.ptt" "c = 0");
  ...
  (* Meta-theory proofs: Goedel, self-consistency, graded choice *)
  ...
  (* Credence inference tests *)
  test "credence_infer.ptt succeeds" (check_succeeds "test/proofs/credence_infer.ptt");
  test "credence_infer.ptt preserves credence c" (check_contains "test/proofs/credence_infer.ptt" "c");
