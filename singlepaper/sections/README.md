...
- For foundations, distinguish semantic consequence, proof provenance, dependence contexts, and hypothetical branch semantics. These are separate missing layers, not one truth-table tweak.
