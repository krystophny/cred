...
The previous section is a positive bridge theorem.  The next theorem
shows the collapse does not extend to conditioning.
...
\begin{tabular}{@{}lll@{}}
\toprule
interval & verdict & Lean \\
\midrule
$[\tfrac12,\tfrac12]$ & robust half &
  \Lean{Cred.Examples.RobustCollapse.collapse\_interval\_interior\_robust\_half}\\
$[\tfrac37,\tfrac67]$ & dependence-sensitive &
  \Lean{Cred.Examples.RobustCollapse.collapse\_interval\_boundary\_sensitive}\\
$[0,1]$ & underdetermined &
  \Lean{Cred.Examples.RobustCollapse.zero\_evidence\_collapse\_underdetermined}\\
$[1,0]$ & incoherent &
  \Lean{Cred.Examples.RobustCollapse.empty\_fiber\_collapse\_incoherent}\\
\bottomrule
\end{tabular}
\end{center}
