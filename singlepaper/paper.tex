...
and the differential layer recovers $\mathrm{ContMDiff}$ and the tangent
pushforward $\mathrm{mfderiv}$.  What remains is the higher
differential-geometric superstructure (differential forms, de Rham
cohomology), which mathlib itself does not yet fully provide, and
measure-theoretic dimension (Hausdorff measure, Moran's theorem).  The
staged plan is in \texttt{docs/FOUNDATION\_TRACK\_ROADMAP.md}.
