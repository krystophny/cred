...
\cite{hajek1998,esteva2001,cintula2011}.  More generally, fuzzy
logics choose a carrier and a conjunction-like operation, then study
the induced connectives.  The present system uses that algebraic data
for a different purpose.  It forms the external fiber
...
\cite{cox1961,jaynes2003}.  Standard conditional probability then uses
division at positive evidence.  R\'enyi and Popper instead take
...
objects \cite{walley1991,troffaes2014}.  These schools already supply
most ingredients: positive-evidence division, primitive conditionals,
conditioning over fibers, void antecedents, and set-valued updating.
Cred puts a smaller invariant under them.  The set $\Cond(j,e)$ is the
preimage of one scalar equation.  It becomes wide exactly when
evidence is zero.  Its width records loss of constraint, not subjective
indecision.
...
conditional probability, set-valued probability, or paraconsistency.
Those are established.  The publishable contribution is the verified
conjunction of six
claims:
\[
\begin{array}{ll}
