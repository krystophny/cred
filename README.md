...
Dependence                  supplied joints J(A,B); not fixed by marginals
...
- `no_truthfunctional_cond_bridge`: the axis-separation theorem; no truth-functional conditional bridge exists
...
- Nelsen (2006): copulas and dependence structure
