...
- `forallElimCertificateTree_headersShapeOK`
- `equalitySubstitutionCertificateTree_headersShapeOK`
...
- `forallElimCertificateTree_missing_child_headers_fail`
- `equalitySubstitutionCertificateTree_missing_child_headers_fail`
...
Foundation checker soundness (from Foundation/CheckerSoundness.lean):
...
- `SerializedFoundationHeader.decode`
- `SerializedFoundationHeader.decodeForPayload`
- `SerializedFoundationHeader.decode_some_shapeOK`
- `SerializedFoundationHeader.decode_none_of_unknown`
