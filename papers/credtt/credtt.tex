...
\begin{enumerate}
    ...
    \end{itemize}
    \item \textbf{Agda formalization} (\texttt{agda/CredTT/}): Syntax, typing rules with credence multiplication, MLTT embedding theorem. Note: Agda has credence-annotated \emph{typing rules} (in \texttt{Judgment.agda}) but not a \emph{type-checking algorithm}---the OCaml implementation provides the algorithmic type checker while Agda provides the specification
\end{enumerate}
